...
<div class="row" style="background-color :  rgb(27,27,27)">
	...
	<form action="iqac_admin_signupphp.php"  method="post" >
	<div class="row ">
	...
	<div class="col-md-4">
						...
						<a type="button " class="btn btn-outline-danger" display="inline-block" width="50px" href="iqac_admin.php"> <i class="fa fa-ban" aria-hidden="true"></i>   CANCEL</a>
	</div>
