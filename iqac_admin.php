...
<a href="iqac_admin_achievements.php" class="btn btn-outline-primary btn-lg" role="button">Add an Achievement</a>
<a href="iqac_admin_events.php" class="btn btn-outline-primary btn-lg" role="button" >Add an Event</a>
